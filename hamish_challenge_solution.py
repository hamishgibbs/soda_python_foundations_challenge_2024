...
"""
My hypotheses: 
"Entire" places will be pricier than shared.
Descriptions mention 'luxury' sounding keywords will be associated with higher prices.
Large places will be more expensive.
Places in central london will be more expensive.
"""
#%%
# %%
